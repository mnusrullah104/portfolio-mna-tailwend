    ...
    <div className="home-main-page">
      ...
      <div className="flex flex-col md:flex-row items-center gap-28 mt-16 font-sans">
        <div className="text-white flex flex-col gap-2 p-12 max-w-lg">
          ...
          <div className="text-3xl font-bold">Muhammad Nasrullah</div> {/* Choose the correct name */}
        ...
        <div className="hover:scale-105 transition-transform duration-300">
          <Image src="/mna17.png" alt="mna's photo" width={400} height={400} className="w-full h-full"/> {/* Choose the correct image */}
        </div>
      </div>
